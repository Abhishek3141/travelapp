...
import { FlatList, SafeAreaView, View, Text, ImageBackground,Pressable,Image } from 'react-native';
...
const AttractionDetail = ({navigation, route}) => {
    ...
    <SafeAreaView style={styles.container}> 
        ...
        <InfoCard text={item?.address} icon={require('../../assets/locationDetail.png')}/>
        <InfoCard text={`OPEN
